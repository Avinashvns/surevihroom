...
class ApiCaller{
  ...
  // Get Api Calling
  static Future<dynamic> callTheGetApi(String sitename,String path,Map<String , String> map)async{
...
//   get Post Calling
  static Future<dynamic> callThePostApi(String sitename, String path, Map<String, String>map) async{
    final url=Uri.http(sitename,path,map);
    print(url);
    try{
